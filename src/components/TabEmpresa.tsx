    ...
    <div className="overflow-x-auto">
      <table className="w-full">
        <thead><tr>
          ...
          <th className="table-th" style={{width:160}}>Status / Ações</th>
          <th className="table-th" style={{width:130}}>Pago em</th>
        </tr></thead>
        <tbody>
          {items.length===0&&<tr><td colSpan={6} className="text-center text-gray-400 text-sm py-6">Nenhum lançamento</td></tr>}
          {items.map((r:any)=>{
